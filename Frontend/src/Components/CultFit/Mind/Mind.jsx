...
function Mind() {
  ...
  return (
    <div>
      ...
      <Box marginLeft="15%" marginRight="15%" marginTop="2%" marginBottom='5%'>
        <Text fontWeight='bold' fontSize='130%' >EXPERTS TO HELP YOU</Text>
        <Grid marginBottom='5%' templateColumns={{base:"repeat(1, 1fr)",sm:"repeat(3, 1fr)",md:"repeat(2, 1fr)",lg:"repeat(2, 1fr)",xl:"repeat(2, 1fr)"}} gap={6}>
          {expert.map((e) => {
            return (
              <GridItem _hover={{boxShadow:'2px 3px 10px rgb(0 0 0 / 0.2)'}} >
              <Box borderRadius='5'  >
              <Box borderRadius='5px' bgImage={e.Img} bgRepeat='no-repeat' bgSize='107%'  h='48' >
         <Text marginLeft='5%' paddingTop='5%' fontWeight='bold' fontSize='140%' >{e.Head}</Text>
          <Divider width='5%' marginLeft='6%' marginTop='1%' color='black' />
          <Text fontWeight='semibold' marginTop='1%' marginLeft='5%' fontSize='80%' >{e.Desc}</Text>
          <Text fontWeight='semibold' marginLeft='7%' marginTop='2%'>{e.time}</Text>
         <Text fontWeight='bold' marginTop='5%' marginLeft='5%' >{e.price}</Text>
        </Box>
              </Box>
              </GridItem>
            );
  ...
  <AccordionItem>
    ...
    Whether you are experiencing symptoms that come in the way of daily living or want to explore issues experienced in the past or are keen on enhancing your wellbeing and growth in life - therapy is suitable for all.    </AccordionPanel>
  </AccordionItem>
  ...
  <AccordionItem>
    ...
    <AccordionPanel marginLeft='2%'  marginRight='40%'  color='#cccfd1' fontWeight='semibold' fontSize='110%' pb={4}>
    Your therapist will focus on getting to know you better through the first session. Together, the two of you will identify goals for follow up sessions. Your therapist may also share a few exercises for you to practice, if relevant.     </AccordionPanel>
  </AccordionItem>
  ...
  <AccordionItem>
    ...
    <AccordionPanel marginLeft='2%'  marginRight='40%' color='#cccfd1' fontWeight='semibold' fontSize='110%' pb={4}>
    Therapists go deep into our problems with us. They help us understand ourselves better and plan for recovery without using medicines. Psychiatrists diagnose and treat chronic mental health conditions and may use medicines.      </AccordionPanel>
  </AccordionItem>
  ...
  <AccordionItem>
    ...
    <AccordionPanel marginLeft='2%'  marginRight='40%' color='#cccfd1' fontWeight='semibold' fontSize='110%' pb={4}>
    A Therapy pack helps with continuity of your wellness journey, without having to bother about booking sessions one at a time. Your Therapist will recommend the number of sessions that you might need to address your challenges. We recommend you buy a pack only after a discussion with the therapist.     </AccordionPanel>
  </AccordionItem>
  ...
  <AccordionItem>
    ...
    <AccordionPanel marginLeft='2%' marginRight='40%' color='#cccfd1' fontWeight='semibold' fontSize='110%' pb={4}>
    Here’s how you can book a therapy session from the cure.fit app: Log into the cure.fit app From the bottom of the To-Do page, pick mind.fit Pick 1 on 1 therapy Pick a preferred center and time slot Make a payment That’s all!    </AccordionPanel>
  </AccordionItem>
